    ...
    if not final_display_df.empty:
        ...
        if selected_rows:
            ...
            with tab_filter:
                ...
                if use_cond4 or True: # 💡 強制補齊 X 日收盤明細
                ...
                if use_cond6 or True: # 💡 強制補齊 X 日主力明細
            ...
            with tab_disposal:
                ...
                # 反算 Clause 4-1-1 累積漲跌幅 (回溯第 5 天前的收盤價)
                if len(stock_hist) >= 6:
